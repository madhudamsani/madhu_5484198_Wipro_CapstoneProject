...
class TestEndToEndPropertyFlow:
    ...
    def test_end_to_end_property_flow(self, driver):
        ...
        with allure.step("Login Into 99acres"):
            ...
            logger.info("Waiting 20 seconds for manual OTP entry")
            time.sleep(20)
        ...
        with allure.step("Search Rental Property"):
            ...
            home.click_rent_tab()
            logger.info(f"Entering Location: {data['location']}")
        ...
        logger.info(f"Results Heading: {results_page.get_results_heading()}")

        initial_results_count = results_page.get_results_count()

        logger.info(f"Initial Results Count: {initial_results_count}")
        ...
        with allure.step("Apply Flat/Apartment Filter"):
            ...
            assert filters.is_applied_filter_present("Flat/Apartment")
        ...
        with allure.step("Apply Single Men Filter"):
            ...
            assert filters.is_applied_filter_present("Single Men")

        with allure.step("Sort Results By Price Low To High"):

            logger.info("Applying Sort: Price Low To High")
            filters.sort_price_low_to_high()


        with allure.step("Verify All Required Filters Applied"):
        ...
        with allure.step("Open First Filtered Property"):

            logger.info("Selecting First Filtered Property")
        ...
        with allure.step("Switch To Property Window"):
            ...
            logger.info("Switching To Property Window")
        ...
        with allure.step("Get Property Details"):
            ...
            logger.info(f"Property Title: {property_title[:150]}")
            logger.info(f"Rent Amount: {rent_amount}")
        ...
        with allure.step("Open Owner Details"):
            ...
            logger.info("Opening Owner Details Section")
        ...
        with allure.step("Verify Contact Section"):

            logger.info("Verifying Contact Section" )
            assert property_page.verify_contact_section()
            property_page.close_fraud_alert_popup()
            home.capture_screenshot("owner_details")

        property_page.handle_blocking_popups()

        logger.info("End-to-End Property Flow Completed Successfully")